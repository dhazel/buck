...
;============================================================
; Mult8to16Bit -- performs the operation HL = DE * A
...
;  tested: yes
;============================================================
Mult8to16Bit:                     ; this routine performs the operation HL=DE*A
...
Mult8to16BitLoop:
  ...
  jp nc,Mult8to16BitSkip          ; if zero, we skip the addition (jp is used for speed)
