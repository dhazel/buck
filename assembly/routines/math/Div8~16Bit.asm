...
;============================================================
; Div8~16Bit -- performs the operation HL = HL / D
;  input: HL = dividend
;         D  = divisor
;  output: HL = quotient
;  affects: B  -> 0
...
;============================================================
Div8~16Bit:                      ; this routine performs the operation HL=HL/D
...
Div8~16Bit_Loop:
  ...
  jp c,Div8~16Bit_NextBit        ; if not, advancing without subtraction
  sub d                          ; subtracting the divisor
  inc l                          ; and setting the next digit of the quotient
Div8~16Bit_NextBit:
  djnz Div8~16Bit_Loop
  ret          
